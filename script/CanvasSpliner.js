  ...
  */
  ...
  class CanvasSpliner {
    ...
    _drawCoordinates(x, y){
      ...
      this._ctx.font = textSize + "px Inconsolata";
      this._ctx.fillText("Velocity IN (x): " + Math.round(x * 127), 10/this._screenRatio, 20/this._screenRatio);
      this._ctx.fillText("Velocity OUT (y): " + Math.round(y * 127), 10/this._screenRatio, 35/this._screenRatio);
    }
